...
public class Application {
    ...
    public static void  main(String[] args){
        ...
        * 2. 게으른 초기화
         */
        EagerSingleton eager1 = EagerSingleton.getSInstance();
        EagerSingleton eager2 = EagerSingleton.getSInstance();
        System.out.println(eager1);
        System.out.println(eager2);

        //EagerSingleton eager3 = new EagerSingleton();

        LazySingleton lazy1 = LazySingleton.getSInstance();
        LazySingleton lazy2 = LazySingleton.getSInstance();
